...
import { SMFSBnftContract, blockExplorer } from "@/consts/parameters";
import { NFTCard } from "@/components/NFTCard";


export default function SMFSBGallery() {
...
{ <a href={blockExplorer+"/address/"+SMFSBnftContract.address} className = "pointer" target={"_blank"}>{contractMetadata.name}</a>}
</h1>
...
<NFTCard nft={nft} nftName = {"SMFSB"} key={nft.id.toString()} />
) : null}
