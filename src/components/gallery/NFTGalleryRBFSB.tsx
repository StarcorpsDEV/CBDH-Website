...
import { RBFSBnftContract, blockExplorer } from "@/consts/parameters";
...
{ <a href={blockExplorer+"/address/"+RBFSBnftContract.address} className = "pointer" target={"_blank"}>{contractMetadata.name}</a>}
</h1>
