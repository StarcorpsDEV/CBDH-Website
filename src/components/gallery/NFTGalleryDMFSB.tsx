...
export default function DMFSBGallery() {
...
{ <a href={blockExplorer+"/address/"+DMFSBnftContract.address} className = "pointer" target={"_blank"}>{contractMetadata.name}</a>}
</h1>
...
<NFTCard nft={nft} nftName = {"DMFSB"} key={nft.id.toString()} />
) : null}
