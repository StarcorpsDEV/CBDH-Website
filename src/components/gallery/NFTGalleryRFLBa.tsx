...
import { RFLBanftContract } from "@/consts/parameters";
import { NFTCard } from "@/components/NFTCard";


export default function RFLBaGallery() {
...
{String(contractMetadata.symbol)}
</h2>
</div>
) : contractLoading ? (
...
<NFTCard nft={nft} nftName = {"RFLBa"} key={nft.id.toString()} />
) : null}
