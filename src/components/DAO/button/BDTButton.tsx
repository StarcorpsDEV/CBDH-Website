...
import { DMFUSDC_Uniswap_APP, DMFMATIC_Sushi_APP, liquidity_pool_interface, DMFUSDC_Uniswap, DMFMATIC_Sushi, BDT_Staking_Pool_URL, BDT_Aragon_DAO_URL } from "@/consts/parameters";
    ...
    <div>
      <a onClick={
         function (){
          ...
          $("#DMFMATIC_Sushi").on("click", function(){
            $("#BDT").html("<embed src="+DMFMATIC_Sushi_APP+" style='width:100% !Important; min-height:700px !Important;'></embed>")
          })
      ...
      <a onClick={
         function (){
          ...
          <div class='col s12 m4' style='margin-bottom:60px;'>
          <a style='padding:12px; padding-right:24px; padding-left:24px; margin:12px; border:1px solid #806868; border-radius:12px;' 
          class='font-bold text-transparent transition bg-clip-text tw-gradient-gold pointer hover' target='_blank' href='${BDT_Aragon_DAO_URL}'>
          AragonDAO</a>
          </div>
          <div class='col s6 m4' style='margin-bottom:60px;'>
          <a style='padding:12px; padding-right:24px; padding-left:24px; margin:12px; border:1px solid #806868; border-radius:12px;' 
          ...
          <div class='col s6 m4'>
          <a style='padding:12px; padding-right:24px; padding-left:24px; margin:12px; border:1px solid #806868; border-radius:12px;' 
          class='font-bold text-transparent transition bg-clip-text tw-gradient-gold pointer hover' target='_blank' href='${liquidity_pool_interface+DMFMATIC_Sushi}'>
          $DMFMATIC</a>
          </div>
          </div>
          </div>
