...
import { client, RGFSBnftContract } from "@/consts/parameters";
...
const NFTPage = () => {
  ...
  return (
    ...
    <div className="font-bold text-transparent transition bg-clip-text tw-gradient-green">
      ...
      <div className="card-content mx-auto flex min-h-screen w-full max-w-7xl flex-col px-4 md:flex-row ">
        ...
        <Breadcrumb url={"/RGFSB"} nftName={"Refined Green Fluid"} nftId={String(id)}/>
          {nft ? (
            <MediaRenderer
              client={client}
