...
import { client, RFLBanftContract } from "@/consts/parameters";
...
const NFTPage = () => {
  ...
  return (
    ...
    <div className="font-bold text-transparent transition bg-clip-text tw-gradient-bronze">
    ...
    <Breadcrumb url={"/RFLBa"} nftName={"Refined Fluids Liquid Badgers α"} nftId={String(id)}/>
          {nft ? (
            <MediaRenderer
              client={client}
        ...
        <div className="mt-10 flex w-full flex-col gap-6 px-10 md:mt-0 md:min-h-screen md:w-1/2">
          ...
          {isLoading ? (
            ...
            <p className="text-lg font-medium text-white">
              {String(nft?.metadata.description).split(" More information about the Collectif are available on our website")[0]}
            </p>
          )}
