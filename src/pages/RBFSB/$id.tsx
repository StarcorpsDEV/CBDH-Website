...
import { client, RBFSBnftContract } from "@/consts/parameters";
...
const NFTPage = () => {
  ...
  return (
    ...
    <div className="font-bold text-transparent transition bg-clip-text tw-gradient-blue">
    ...
    <Breadcrumb url={"/RBFSB"} nftName={"Refined Blue Fluid"} nftId={String(id)}/>
          {nft ? (
            <MediaRenderer
              client={client}
